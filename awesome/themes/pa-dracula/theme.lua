...
local theme                                     = {}
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/themes/pa-dracula"
...
-- Binary clock
local binclock = require("themes.pa-dracula.binclock"){
    height = dpi(16),
    show_seconds = true,
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            arrow(theme.bg_normal, "#282a36"),
            wibox.container.background(wibox.container.margin(task, dpi(3), dpi(7)), "#282a36"),
            arrow("#282a36", "#44475a"),
            ...
            arrow("#44475a", "#bd93f9"),
            wibox.container.background(wibox.container.margin(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(4)), "#bd93f9"),
            arrow("#bd93f9", "#6272a4"),
            wibox.container.background(wibox.container.margin(wibox.widget { tempicon, temp.widget, layout = wibox.layout.align.horizontal }, dpi(4), dpi(4)), "#6272a4"),
            arrow("#6272a4", "#8be9fd"),
            wibox.container.background(wibox.container.margin(wibox.widget { volicon, theme.volume, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#8be9fd"),
            arrow("#8be9fd", "#f1fa8c"),
            wibox.container.background(wibox.container.margin(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#f1fa8c"),
            arrow("#f1fa8c", "#ffb86c"),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#ffb86c"),
            arrow("#ffb86c", "#ff5555"),
            wibox.container.background(wibox.container.margin(binclock.widget, dpi(4), dpi(8)), "#ff5555"),
            arrow("#ff5555", "alpha"),
            --]]
            s.mylayoutbox,
        },
