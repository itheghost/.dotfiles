...
local theme                                     = {}
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/themes/pa-rs5"
...
theme.volume = lain.widget.alsa({
	...
	--		volicon:set_image(theme.wdiget_vol)
		else
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            arrow(theme.bg_normal, "#98971a"),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, dpi(2), dpi(3)), "#98971a"),
            arrow("#98971a", "#689d6a"),
            wibox.container.background(wibox.container.margin(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(4)), "#689d6a"),
            arrow("#689d6a", "#458588"),
            wibox.container.background(wibox.container.margin(wibox.widget { tempicon, temp.widget, layout = wibox.layout.align.horizontal }, dpi(4), dpi(4)), "#458588"),
            arrow("#458588", "#b16286"),
            wibox.container.background(wibox.container.margin(wibox.widget { volicon, theme.volume, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#b16286"),
            arrow("#b16286", "#cc241d"),
            wibox.container.background(wibox.container.margin(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#cc241d"),
            arrow("#cc241d", "#d65d0e"),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#d65d0e"),
            arrow("#d65d0e", "#d79921"),
            wibox.container.background(wibox.container.margin(binclock.widget, dpi(4), dpi(8)), "#d79921"),
            arrow("#d79921", "alpha"),
            --]]
            s.mylayoutbox,
        },
